...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let basePath = "https://cdn.openfin.co/demos/os-launchpad/";
    ...
    document.getElementsByClassName("of-os-tb-minimize")[0].addEventListener('click', function () {
        fin.desktop.Window.getCurrent().minimize();
    });
    document.getElementsByClassName("of-os-tb-close")[0].addEventListener('click', function () {
        fin.desktop.Application.getCurrent().close();
    });
    // maximize/restore
    var maximized = false;
    document.getElementsByClassName("of-os-tb-maximize")[0].addEventListener('click', function (e) {
        if (maximized === false) {
    ...
    document.getElementsByClassName("of-os-tb-undock")[0].addEventListener('click', function () {
