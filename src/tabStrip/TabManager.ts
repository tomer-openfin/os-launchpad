...
export class TabManager {
   ...
   */
  addTab(tabID: WindowIdentity, tabProps: TabProperties, index: number) {
   ...
   * @param {WindowIdentity} tabID An object containing the uuid, name for the external application/window.
   */
  removeTab(tabID: WindowIdentity, closeApp = false): void {
   ...
   */
  setActiveTab(tabID: WindowIdentity | null = null): void {
    if (tabID) {
      const tab: Tab | undefined = this.getTab(tabID);
   ...
   * @param {WindowIdentity} tabID An object containing the uuid, name for the external application/window.
   */
  getTab(tabID: WindowIdentity): Tab | undefined {
