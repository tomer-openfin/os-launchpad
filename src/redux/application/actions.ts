...
const SET_RVM_VERSION = 'SET_RVM_VERSION';
const SET_MANIFEST_URL = 'SET_MANIFEST_URL';
...
export const setRvmVersion = createAction(SET_RVM_VERSION)<string>();
export const setManifestUrl = createAction(SET_MANIFEST_URL)<string>();
