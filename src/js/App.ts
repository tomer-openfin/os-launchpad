...
export class App {
  /**
   * @member appInfo Contains the information for this application
   */
  ...
  render(hotbar = false): HTMLElement {
    ...
    appSquare.onclick = (): void => {
      ContentManager.createFromManifestAndRun(this.appInfo.manifest_url);
    };
